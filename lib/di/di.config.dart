...
import 'package:smartfood/data/datasources/user/remote/user.datasource.dart'
    as _i9;
import 'package:smartfood/data/datasources/user/user.datasource.dart' as _i10;
import 'package:smartfood/data/repositories/user.repository.dart' as _i11;
import 'package:smartfood/di/modules/local_module.dart' as _i12;
import 'package:smartfood/di/modules/network_module.dart' as _i13;
...
Future<_i1.GetIt> initGetIt(
  ...
  gh.lazySingleton<_i9.UserRemoteDataSource>(
      () => _i9.UserRemoteDataSource(dioHelper: gh<_i8.DioHelper>()));
  gh.lazySingleton<_i10.UserDataSource>(() => _i10.UserDataSource(
  ...
  gh.lazySingleton<_i11.UserRepository>(
      () => _i11.UserRepository(dataSource: gh<_i10.UserDataSource>()));
  return getIt;
}
